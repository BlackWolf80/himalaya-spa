    ...
    var a = {
        ...
        m = function() {
            ...
            if ("Microsoft Internet Explorer" === navigator.appName) {
                ...
                null !== new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})").exec(b) && (a = !0)
            }
            return a
        },
        n = function() {
            ...
            if ("Microsoft Internet Explorer" === navigator.appName) {
                var b = navigator.userAgent;
                null !== new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})").exec(b) && (a = parseFloat(RegExp.$1), a = a < 9)
            }
            return a
        },
        o = function() {
        ...
        p = function(a) {
            ...
            return e.prototype = {
                ...
                _waveJumpToEnd: function() {
                    clearTimeout(this.showPartsTimeout), void 0 !== this.intPrevPtPageNumber && this._showParts(this.$element.find(".pt-part.in-queue").removeClass("in-queue"), this.intPrevPtPageNumber)
                },
                ...
                _showParts: function(a, b) {
                    a.find(".pt-page-current.pt-page-prev").removeClass("pt-page-prev").removeClass("pt-page-current"), a.find(".pt-page-current").addClass("pt-page-prev"), a.find(".pt-page:nth-child(" + b + ")").addClass("pt-page-current"), a.find(".pt-page").removeClass(this.hideEffect).removeClass(this.showEffect), void 0 !== this.prevHideEffect && a.find(".pt-page").removeClass(this.prevHideEffect), void 0 !== this.prevShowEffect && a.find(".pt-page").removeClass(this.prevShowEffect), this.animation && (a.find(".pt-page-prev").addClass(this.hideEffect), a.find(".pt-page-current:not(.pt-page-prev)").addClass(this.showEffect))
                },
                hideActive: function() {
        ...
        t = function(a) {
            ...
            return e.prototype = {
                ...
                canScrollToNext: function() {
                    ...
                    return ("image" === this.jGallery.options.thumbType ? this.$a.outerWidth(!0) * a.find("img").length : this.$a.outerWidth(!0) * a.find("a").length) > this.$container.width() + this.$container.scrollLeft()
                },
        ...
        v = function(a, b, c, d, e, f, g, h) {
            ...
            return k.prototype = {
                update: function() {
                    ...
                    this.$container.attr("data-size", this.jGallery.options.zoomSize), this.$element.find(".pt-page").removeClass(this.jGallery.options.hideEffect).removeClass(this.jGallery.options.showEffect), void 0 !== a && (this.jGallery.options.hideEffect = a[0], this.jGallery.options.showEffect = a[1]), this.initAdvancedAnimation()
                },
                initAdvancedAnimation: function() {
                    void 0 === this.advancedAnimation && (this.advancedAnimation = new g(this.$element)), this.advancedAnimation.setAnimationProperties({
                ...
                enableDrag: function() {
                    var a, b, c, d, e, f, g = this,
                        ...
                        j = function() {
                            var a = h(),
                                b = c - e.pageX;
                            g.$element.off("mousemove touchmove mouseleave touchend"), "fill" === g.jGallery.options.zoomSize && g.$dragNav.removeClass("show").addClass("hide"), g.jGallery.options.swipeEvents && 0 === a && (b > 0 ? g.showNextPhoto() : b < 0 && g.showPrevPhoto())
                        },
                        k = function(a) {
                        ...
                        l = function(c, d) {
                            var e = parseFloat(parseFloat(a) + c),
                                ...
                                q = p.position(),
                                r = {
                                    x: k + e < 0 && n.left + m.width() + e > o.outerWidth(),
                                    y: l + f < 0 && n.top + m.height() + f > o.outerHeight()
                                };
                            return r.x && (h.css({
                                "margin-left": e
                            }), p.css({
                ...
                isLoaded: function(a) {
                    ...
                    if (b) return this.imgIsLoaded(b)
                },
                ...
                loadPhoto: function(a, b, c) {
                    ...
                    (this.jGallery.options.preloadAll ? g : g.find("img.active")).jLoader({
                        interval: 500,
                        skip: ".loaded",
                        start: function() {},
                        success: function() {
                        ...
                        f.options.browserHistory && f.browserHistory(), f.options.autostart && f.autostart(), e(), q.on({
                            keydown: function(a) {
                                if (f.$element.is(":visible")) {
                                    ...
                                    37 === a.which && (a.preventDefault(), f.zoom.slideshowStop(), f.zoom.showPrevPhoto()), 39 === a.which && (a.preventDefault(), f.zoom.slideshowStop(), f.zoom.showNextPhoto())
                                }
                            }
                        })
                    }
                    ...
                    a = p.extend({
                        ...
                        success: function() {
                            new n(b), b.setVariables(), b.thumbnails.init(), b.thumbnails.getElement().append('<span class="fa fa-times jgallery-btn jgallery-close jgallery-btn-small"></span>'), b.generateAlbumsDropdown(), b.setUserOptions(), "fit" !== b.options.zoomSize && "original" !== b.options.zoomSize || b.zoom.$resize.addClass("fa-search-plus"), "fill" === b.options.zoomSize && b.zoom.$resize.addClass("fa-search-minus"), c() || b.$element.addClass("text-shadow"), b.thumbnails.refreshNavigation(), b.zoom.refreshNav(), b.zoom.refreshSize(), b.$this.on("click", "a:has(img)", function(a) {
                                ...
                                var c = p(this);
                                a.preventDefault(), c.is(":not(.active)") ? (b.zoom.slideshowStop(), b.zoom.showPhoto(c)) : b.thumbnails.isFullScreen() && (b.thumbnails.changeViewToBar(),
                                    b.zoom.refreshSize())
